...
import './App.css'
import AppItem from './Components/AppItems'
...
export default class App extends Component {
  ...
  filterApps=()=>{
    const {activeTab,appsdata,searchInput}=this.state
    const filtersbyTab = appsdata.filter((each)=>
    each.category===activeTab)
    
    const filterbySearch=filtersbyTab.filter((each)=>
    ...
    return (
      <div className='main-container'>
        ...
        <div className='top-inputsearch'>
            ...
            />
           <img className='searchimag' src="https://assets.ccbp.in/frontend/react-js/app-store/app-store-search-img.png"/>
      ...
      
        {
          tabsList.map((eachItem)=>(
                    <TabItem item={eachItem} key={eachItem.tabId} onClickTab={this.onTab} isActive={eachItem.tabId===activeTab}/>
